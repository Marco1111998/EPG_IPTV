...
sed -i "/live_tvi_ficcao/ c https://video-auth6.iol.pt/live_tvi_ficcao/live_tvi_ficcao/tvificcao-720p/playlist.m3u8?wmsAuthSign=$(wget https://services.iol.pt/matrix?userId= -o /dev/null -O -)/" m3upt.m3u

# TVI AFRICA - update the stream URL of TVI AFRICA

sed -i "/live_tvi_africa/ c https://video-auth6.iol.pt/live_tvi_africa/live_tvi_africa/tviafrica-480p/playlist.m3u8?wmsAuthSign=$(wget https://services.iol.pt/matrix?userId= -o /dev/null -O -)/" m3upt.m3u

# TVI REALITY - update the stream URL of TVI REALITY

sed -i "/live_tvi_reality/ c https://video-auth1.iol.pt/live_tvi_reality/live_tvi_reality/tvireality-480p/playlist.m3u8?wmsAuthSign=$(wget https://services.iol.pt/matrix?userId= -o /dev/null -O -)/" m3upt.m3u
